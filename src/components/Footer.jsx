...
const Footer = () => {
  return (
    <div className="bg-[#02060C] w-full hue-rotate-15 p-10 text-white flex justify-around">
      <div className="f-link w-[160px]">
        <div className="logo flex">
          <Logo />
          <h1 className="ml-2 font-bold text-[28px] -mt-1">Swiggy</h1>
        </div>
        <div className="text-[1.2rem] cursor-pointer text-[#ebe9e999] font-bold mt-4">
      ...
      <div className="f-link w-[160px]">
        <div className="link">
          ...
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
            About
          </li>
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
            Careers
      ...
      <div className="f-link w-[160px]">
        <div className="link">
          ...
          <h1 className="text-xl font-bold mb-4 mt-4">Legal</h1>
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
            Terms & Conditions
          </li>
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
      ...
      <div className="f-link w-[160px]">
        <div className="link">
          <h1 className="text-xl font-bold mb-4">We deliver to:</h1>
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
            Bangalore
          </li>
          <li className="list-none text-[1.2rem] cursor-pointer text-[#9A9B9E] font-bold">
